...
const talks = [
  ...
  },
  {
    ...
    slug: "http://varya.me/design-systems-thinking/",
  ...
  },
  {
    ...
    slug: "http://varya.me/ds-in-wild-tallinn/",
  ...
  },
  {
    ...
    slug: "https://dsconference.com/ws-intergalactico/",
  },
  {
  ...
  components using modern CSS component approaches.`,
    slug: "http://varya.me/component-development-css-2017/",
  },
  {
  ...
  components using CSS.`,
    slug: "http://varya.me/component-development-css-2016/",
  },
  {
  ...
  },
  {
    ...
    slug: "http://varya.me/reactjs-hackathon/",
  },
  {
    title: "Doing nothing for visual regression testing",
  ...
  meetup in October 2015.`,
    slug: "http://varya.me/doing-nothing-for-visual-regression-2015/",
  },
  {
  ...
  },
  {
    ...
    description: `This article at _SmashingMagazine_ was published on 5th March 2105. It explained the motivation and benefits
  ...
  },
  {
    ...
    slug: "http://bem.info/tutorials/bem-js-tutorial/",
  },
  {
    title: "Tutorial on JavaScript components with i-bem.js",
  ...
  efficient BEMHTML templates and declarative JavaScript i-bem.js.`,
    slug: "http://bem.info/articles/start-with-project-stub/",
  },
  {
      ...
      {!slug && links && (
        <Box direction="row" justify="around">
          {Object.entries(links).map(([label, href]) => (
            <Button primary key={label} label={label} href={href} />
          ))}
        </Box>
      )}
    </Widget>
