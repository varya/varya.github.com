...
const NotFoundPage = ({ location }) => (
  ...
  >
    ...
    <Paragraph>
      The link you followed might be broken, or the page have been removed. Try
      to browse my <Link to="/blog">blog</Link> to find what you&apos;re looking
      for or <Link to="/services">check what I do</Link>.
    </Paragraph>
  </Page>
);
